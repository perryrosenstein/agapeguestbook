class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:uid, :first_name, :last_name, :email, :host, :arrival_date, :departure_date, :where_from, :why_in_sf, :note, :provider, :oauth_token, :oauth_expires_at)
    end
